  ...
  return (
    <LegalLayout title="Política de Cookies" date="21 de Janeiro de 2026">
      ...
      <p>
        ...
        recursos que eles adicionam a este site.
      </p>
      ...
      <div className="space-y-6 mt-6">
        <div className="border-l-4 border-[#1A3879] pl-4">
          <h4 className="font-bold text-gray-900 m-0">Cookies relacionados à conta</h4>
      ...
      <p>
        Você pode impedir a configuração de cookies ajustando as configurações do seu navegador (consulte 
