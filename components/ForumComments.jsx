    ...
    <article
      ...
      className={`
        ...
        ${comunidade
          ...
          : "p-4 lg:py-6 h-[115px] lg:-w-[400px] 2xl:w-[450px] text-xs 2xl:text-sm"}
      `}
    >
      <img
        src={image}
      ...
      <div className="flex flex-col gap-1">
        <p className={`${comunidade ? "text-[13px] line-clamp-2" : "text-[12.5px] 2xl:text-sm"}`}>
          {text}
        </p>
        <span className={`${comunidade ? "text-[11px]" : "text-[11px] 2xl:text-xs"} text-gray-600`}>
          {author}
        </span>
      </div>
    </article>
