      ...
      >
        ...
        <div className="hidden md:flex items-center gap-x-4">
          <button 
            ...
            title={user?.isLoggedIn ? "Meu Perfil" : t('components.header.actions.open_profile')}
          >
            {user?.isLoggedIn ? (
               <Image 
                 src={UserLoggedIcon} 
        ...
        {/* HAMBURGER MOBILE */}
        <button className="md:hidden flex flex-col gap-1.5 p-2" onClick={() => setOpen(true)}>
                  ...
                  {user?.isLoggedIn ? (
                    <>
                      ...
                      <div className="flex flex-col text-left">
                        ...
                        <span className="text-xs text-gray-300 mt-0.5">Acessar conta</span>
                      </div>
                    </>
                  ) : (
                    <>
                      ...
                      <div className="bg-white/20 p-2.5 rounded-full shadow-sm border border-white/30">
                        ...
                        <Image src={User} width={24} height={24} alt="Perfil" className="invert" />
                      </div>
