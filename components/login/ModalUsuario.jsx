      ...
      <div className="relative w-full max-w-[415px] bg-white rounded-[20px]  shadow-2xl flex flex-col items-center">
        ...
        {view === "selection" && (
          <div className="w-full flex flex-col gap-1 animate-in fade-in duration-300">
            ...
            <button onClick={() => setView("register")} className="w-full bg-[#1A3879] text-white font-bold py-4 rounded-xl cursor-pointer">
            ...
            <button onClick={() => setView("login")} className="w-full border-2 border-[#1A3879] text-[#1A3879] font-bold py-3.5 rounded-xl cursor-pointer">
            ...
            <p className="mt-3 text-center text-xs text-gray-500 px-4">
              ...
              <Link href={'/termos'} className="font-bold underline">{t('components.user_modal.selection.terms')}</Link> e <Link href={'/privacidade'} className="font-bold underline">{t('components.user_modal.selection.privacy')}</Link>
            </p>
            </div>
          </div>
        )}
        ...
        {view === "login" && (
          <div className="w-full animate-in slide-in-from-right-4 duration-300">
            ...
            <div className="p-6 pt-0 flex flex-col gap-3">
                ...
                <button onClick={() => setView("selection")} className="w-full text-xs text-gray-400 underline mt-1 cursor-pointer">
        ...
        {view === "register" && (
          <div className="w-full animate-in slide-in-from-right-4 duration-300">
            ...
            <div className="p-6 pt-0 flex flex-col gap-3">
                ...
                <button onClick={() => setView("register_step2")} className="w-full bg-[#1A3879] text-white font-bold py-4 rounded-xl mt-2 cursor-pointer">
        ...
        {view === "register_step2" && (
          <div className="w-full animate-in slide-in-from-right-4 duration-300">
            ...
            <div className="p-6 pt-0 flex flex-col gap-3">
                ...
                <div className="w-full mb-3">
                    ...
                    <div className="w-20 h-20 bg-[#5B63B1] rounded-full flex items-center justify-center overflow-hidden border-4 border-white shadow-md">
                        ...
                        <span className="text-white text-xs text-center p-1 cursor-pointer">
                            {t('components.user_modal.register_step2.icon_placeholder')}
                        </span>
                    </div>
                    
                    <Image src={IconsUsers} className="w-66" alt="Icones de usuários" />
                </div>
                ...
                <button onClick={() => setView("register")} className="my-1 text-xs text-gray-400 underline cursor-pointer">
